...
$route['news'] = 'web/news';
$route['news-detail/(:num)'] = 'web/news_detail';
$route['notice'] = 'web/notice';
$route['notice-detail/(:num)'] = 'web/notice_detail';
$route['holiday'] = 'web/holiday';
$route['holiday-detail/(:num)'] = 'web/holiday_detail';
$route['events'] = 'web/events';
$route['event-detail/(:num)'] = 'web/event_detail';
$route['galleries'] = 'web/galleries';
$route['gallery-image/(:num)'] = 'web/gallery_image';
