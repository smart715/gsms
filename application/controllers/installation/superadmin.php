            ...
            <div class="col-md-12 col-sm-12">            
                <?php echo form_open($this->uri->uri_string(), array('name' => 'superadmin', 'id' => 'superadmin', 'class'=>'form-horizontal form-label-left'), ''); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control required" name="phone" id="phone" autocomplete="off" minlength="6" maxlength="20">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control required" name="password" id="password" minlength="6" maxlength="20" autocomplete="off">
                    </div>                   
                    <div class="form-group">
                        <label for="conf_password">Confirm Password</label>
                        <input type="password" class="form-control required" name="conf_password" id="conf_password" minlength="6" maxlength="20" autocomplete="off">
                    </div>
