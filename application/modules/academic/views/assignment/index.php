                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_assignment">
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                ...
                                <div class="item form-group">
                                     <label class="control-label col-md-3 col-sm-3 col-xs-12 chk-label" for="sms_notification" style="padding-top: 0px;"><?php echo $this->lang->line('sms_notification'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                     <label class="control-label col-md-3 col-sm-3 col-xs-12 chk-label" for="email_notification" style="padding-top: 0px;"><?php echo $this->lang->line('email_notification'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
