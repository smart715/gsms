                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    ...
                                                    if($obj->role_id == STUDENT){
                                                        echo $this->lang->line('class').': '.$user->class_name.', '. $this->lang->line('section').': '.$user->section.',<br/> '. $this->lang->line('roll_no'). ':'. $user->roll_no;
                                                    }
                                                    ?>
                                                <?php } ?> 
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(DELETE, 'accounting', 'invoice') && $obj->paid_status == 'unpaid'){ ?>                                                    
                                                    <br/>  <a href="<?php echo site_url('accounting/invoice/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>        
                                            </td>
                                        </tr>
                                        <?php } ?>
