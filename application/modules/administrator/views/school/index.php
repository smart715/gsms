                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($schools) && !empty($schools)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="fn_is_demo" onclick="set_demo_school(<?php echo $obj->id; ?>);" type="checkbox" name="is_demo" id="is_demo_<?php echo $obj->id; ?>" value="<?php echo $obj->id; ?>" <?php if($obj->is_demo ){ echo 'checked="checked"'; } ?> />
                                            </td>
