                                    ...
                                    <div class="row">
                                     ...
                                     <div class="item form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <br/>
                                            <input type="radio" id="type1" name="type_id" value="1" checked 
                                            style="position: relative;opacity: inherit;left: auto;margin: 10px 55px;">
                                            <input type="radio" id="type2" name="type_id" value="2" 
                                            style="position: relative;opacity: inherit;left: auto;margin: 10px 55px;">
                                            <input type="radio" id="type3" name="type_id" value="3" 
                                            style="position: relative;opacity: inherit;left: auto;margin: 10px 48px;">
...
<!-- 
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <img src="<?php echo IMG_URL; ?>/certificate/sample3.png" alt="" width="120" />
                                            <br/>
                                            <input type="radio" id="type1" name="type_id" value="1" 
                                            <?php if($certificate->type_id=='1') echo 'checked'; ?>  
                                            style="position: relative;opacity: inherit;left: auto;margin: 10px 55px;">
                                            <input type="radio" id="type2" name="type_id" value="2" 
                                            <?php if($certificate->type_id=='2') echo 'checked'; ?>  
                                            style="position: relative;opacity: inherit;left: auto;margin: 10px 55px;">
                                            <input type="radio" id="type3" name="type_id" value="3" 
                                            <?php if($certificate->type_id=='3') echo 'checked'; ?>  
                                            style="position: relative;opacity: inherit;left: auto;margin: 10px 48px;">
                                            <div class="help-block"><?php echo form_error('type_id'); ?></div>
                                        </div>
                                        </div>
