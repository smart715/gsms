                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_type_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'certificate', 'type')) { ?>

                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('certificate/type/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_type" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                                        ...
                                        if (isset($certificates) && !empty($certificates)) { ?>
                                            <?php foreach ($certificates as $obj) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="<?php echo IMG_URL; ?>/certificate/sample<?php echo $obj->type_id; ?>.png" alt="" width="120" />
                                                    </td>
                                                    <td>
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <!-- 
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <div class="text-info">Image file format: .jpg, .jpeg</div>
                                    ...
                                    <div class="item form-group">
                                        <div class="row">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"> Signature 1 : left side
                                            </label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <div class="btn btn-default btn-file">
                                                    <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                    <input class="form-control" name="sign1" id="sign1" type="file">
                                                </div>
                                                <div class="text-info">png, jpg. (png preferred) [300x100]</div>
                                                <div class="help-block"><?php echo form_error('sign1'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <div class="row">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="signer_name1"> Signer 1 Name </label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input class="form-control" name="signer_name1" id="signer_name1" value="<?php echo isset($signer_name1) ? $signer_name1 : ''; ?>" placeholder="<?php echo $this->lang->line('signer_name1'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('signer_name1'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <div class="row">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="footer_left"> Signer 1 title</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input class="form-control" name="footer_left" id="footer_left" value="<?php echo isset($footer_left) ? $footer_left : ''; ?>" placeholder="<?php echo $this->lang->line('footer_left'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('footer_left'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <div class="row">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"> Signature 2 : right side
                                            </label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <div class="btn btn-default btn-file">
                                                    <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                    <input class="form-control" name="sign2" id="sign2" type="file">
                                                </div>
                                                <div class="text-info">png, jpg. (png preferred) [300x100]</div>
                                                <div class="help-block"><?php echo form_error('sign2'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <div class="row">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="signer_name2"> Signer 2 Name</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input class="form-control" name="signer_name2" id="signer_name2" value="<?php echo isset($signer_name2) ? $signer_name2 : ''; ?>" placeholder="<?php echo $this->lang->line('signer_name2'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('signer_name2'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <div class="row">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="footer_right">Signer 2 title</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input class="form-control" name="footer_right" id="footer_right" value="<?php echo isset($footer_right) ? $footer_right : ''; ?>" placeholder="<?php echo $this->lang->line('footer_right'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('footer_right'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <div class="row">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"> Template
                                            </label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="hidden" name="prev_type_id" id="prev_type_id" value="<?php echo $certificate->type_id; ?>" />
                                                <img src="<?php echo IMG_URL; ?>/certificate/sample1.png" alt="" width="120" />
                                                <img src="<?php echo IMG_URL; ?>/certificate/sample2.png" alt="" width="120" />
                                                <img src="<?php echo IMG_URL; ?>/certificate/sample3.png" alt="" width="120" />
                                                <br />
                                                <input type="radio" id="type1" name="type_id" value="1" checked style="position: relative;opacity: inherit;left: auto;margin: 10px 55px;">
                                                <input type="radio" id="type2" name="type_id" value="2" style="position: relative;opacity: inherit;left: auto;margin: 10px 55px;">
                                                <input type="radio" id="type3" name="type_id" value="3" style="position: relative;opacity: inherit;left: auto;margin: 10px 48px;">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            <div class="row">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="signer_name1">Signer 1 Name</label>
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input class="form-control" name="signer_name1" id="signer_name1" value="<?php echo isset($certificate) ? $certificate->signer_name1 : ''; ?>" placeholder="<?php echo $this->lang->line('signer_name1'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('signer_name1'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            <div class="row">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="footer_left"> Signer 1 Title</label>
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input class="form-control" name="footer_left" id="footer_left" value="<?php echo isset($certificate) ? $certificate->footer_left : ''; ?>" placeholder="<?php echo $this->lang->line('footer_left'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('footer_left'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            <div class="row">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="signer_name2"> Signer 2 Name</label>
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input class="form-control" name="signer_name2" id="signer_name2" value="<?php echo isset($certificate) ? $certificate->signer_name2 : ''; ?>" placeholder="<?php echo $this->lang->line('signer_name2'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('signer_name2'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            <div class="row">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="footer_right"> Signer 2 Title</label>
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input class="form-control" name="footer_right" id="footer_right" value="<?php echo isset($certificate) ? $certificate->footer_right : ''; ?>" placeholder="<?php echo $this->lang->line('footer_right'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('footer_right'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <img src="<?php echo IMG_URL; ?>/certificate/sample3.png" alt="" width="120" />
                                                    <br />
                                                    <input type="radio" id="type1" name="type_id" value="1" <?php if ($certificate->type_id == '1') echo 'checked'; ?> style="position: relative;opacity: inherit;left: auto;margin: 10px 55px;">
                                                    <input type="radio" id="type2" name="type_id" value="2" <?php if ($certificate->type_id == '2') echo 'checked'; ?> style="position: relative;opacity: inherit;left: auto;margin: 10px 55px;">
                                                    <input type="radio" id="type3" name="type_id" value="3" <?php if ($certificate->type_id == '3') echo 'checked'; ?> style="position: relative;opacity: inherit;left: auto;margin: 10px 48px;">
                                                    <div class="help-block"><?php echo form_error('type_id'); ?></div>
                                                </div>
                                            </div>
                                        </div>
