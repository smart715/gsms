                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($visitors) && !empty($visitors)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php $user = get_user_by_role($obj->role_id, $obj->user_id);  if(isset($user) && !empty($user)){ echo $user->name; ?><br/> [ <?php echo $obj->role; ?> ] <?php } ?> </td>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/visitor/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($post['phone']) ?  $post['phone'] : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" minlength="6" maxlength="20" type="number">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/visitor/edit/'.$visitor->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($visitor->phone) ?  $visitor->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" minlength="6" maxlength="20" type="number">
                                        <div class="help-block"><?php echo form_error('phone'); ?></div>
                                    </div>
                                </div>                               
