                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td align="right">
                                                <?php if ($editable) { ?>
                                                    <input type="number" name="time_<?php echo $obj->type; ?>[5]" value="<?php echo $obj->period_5 ?? ''; ?>" min="0" style="width:80px;">
                                                <?php } else {
                                            ...
                                            <td align="right">
                                                <?php if ($editable) { ?>
                                                    <input type="number" name="time_<?php echo $obj->type; ?>[6]" value="<?php echo $obj->period_6 ?? ''; ?>" min="0" style="width:80px;">
                                                <?php } else {
