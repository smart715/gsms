                                                ...
                                                <?php
                                                    ...
                                                    if(isset($user) && !empty($user)){
                                                        ...
                                                        if($obj->role_id == STUDENT){
                                                            echo '<br/> [ '.$this->lang->line('class').': '.$user->class_name.', '. $this->lang->line('section').': '.$user->section.','. "Student ID". ':'. $user->roll_no . ']';
                                                        }
                                                    }
                                                ?>
                                            </td>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12"  name="role_id"  id="add_role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                            ...
                                            <?php foreach($roles as $obj ){  ?>                                                
                                                <?php if(in_array($obj->id, array(GUARDIAN, SUPER_ADMIN))){ continue;} ?>
...
<script type="text/javascript">
    ...
    function get_category_by_school(form){
        ...
        <?php }elseif(isset($_POST) && !empty($_POST['category_id'])){ ?> 
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
   ...
   function get_class_by_school(){
        ...
        var class_id = '';
        <?php if(isset($issue)){ ?>  
            class_id = '<?php echo $issue->class_id; ?>';
        <?php } ?>
