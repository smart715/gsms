                        ...
                        <div class="tab-pane fade in active" id="tab_edit_warehouse">
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="phone"> <?php echo $this->lang->line('phone'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($warehouse->phone) ?  $warehouse->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" minlength="6" maxlength="20" type="number">
                                        <div class="help-block"><?php echo form_error('phone'); ?></div>
                                    </div>
                                </div>
