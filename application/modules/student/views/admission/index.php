                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="add_phone" value="<?php echo isset($admission->phone) ?  $admission->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" minlength="6" maxlength="20" type="number" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="section_id" id="edit_section_id" required="required" onchange="get_roll_no(this.value);">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                               ...
                               <div class="row">        
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control col-md-7 col-xs-12"  name="roll_no"  id="roll_no" value="" placeholder="<?php echo "Student ID"; ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="row"> 
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="password"  id="password" value="" required="required" placeholder="<?php echo $this->lang->line('password'); ?>" type="password" minlength="6" maxlength="20" autocomplete="off">
 ...
 <script type="text/javascript">
    ...
    function get_class_by_school(school_id, class_id){
      ...
      function get_roll_no(section_id){       
        ...
        if(!section_id){ $('#roll_no').val('');  return false; }
