                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-box">
                                    ...
                                    <input  type="number"  minlength="6" maxlength="20" name="phone" id="phone" placeholder="<?php echo $this->lang->line('phone'); ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-box">
...
<div class="map-area"> 
    <iframe src="<?php echo $school->google_map; ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
<?php }?>
