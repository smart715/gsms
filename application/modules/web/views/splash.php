...
<body>
                    ...
                    <div class="stellarnav">
                        <ul>
                            ...
                            <?php if (isset($schools) && count($schools) > 0) { ?>
                                <li>
                                    <a class="visit-school" data-toggle="modal" data-target=".find-school-modal-lg" class="text" style="cursor: pointer;"><?php echo $this->lang->line('visit_school'); ?> </a>
                                </li>
                            <?php } ?>
    ...
    <div id="find-school-dialog" class="modal fade find-school-modal-lg" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Find Your School</h4>
                                ...
                                <div class="col-lg-6 col-sm-12 col-12 select-div">
                                    <select class="form-control single-select" name="role_id" id="go_school_list" required="required" style="font-size: medium;    height: auto;">
                                        ...
                                        <?php foreach ($schools as $obj) { ?>
                                            <option value="<?php echo ($obj->subdomain . "." . $this->config->item('domain')); ?>"><?php echo $obj->school_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" style="font-size: medium ">Close</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="video-area" id="_video">
        <div class="container container-big">
            ...
            <?php if ($setting->demo_video == 'youtube' && $setting->video_id != '') { ?>
                <iframe class="youtube-player" type="text/html" style="width:100%; height:550px;" height="550" src="https://www.youtube.com/embed/<?php echo $setting->video_id; ?>" frameborder="0">
                </iframe>
            <?php } else if ($setting->demo_video == 'vimeo' && $setting->video_id != '') { ?>

                <iframe src="https://player.vimeo.com/video/<?php echo $setting->video_id; ?>" style="width:100%; height:550px;" height="500" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                <script src="https://player.vimeo.com/api/player.js"></script>
            <?php } else { ?>
                <iframe class="youtube-player" style="width:100%; height:550px;" height="550" src="https://www.youtube.com/embed/fUUqVSEnpA4" frameborder="0">
                </iframe>
            <?php } ?>
        </div>
    </section>
                        ...
                        <div class="col-xl-4 col-md-4 col-12">
                            <div class="single-pricing">
                                ...
                                <ul>
                                    ...
                                    <li>Is Enable Grade Report <span><?php echo $obj->is_enable_grade_report ? '<i class="fas fa-check"></i>' : '<i class="fa fa-times-circle"></i>'; ?> </span></li>
                                    <li>Is Enable Report Card <span><?php echo $obj->is_enable_report_card ? '<i class="fas fa-check"></i>' : '<i class="fa fa-times-circle"></i>'; ?> </span></li>
                                    <li>Is Enable Transcript <span><?php echo $obj->is_enable_transcript ? '<i class="fas fa-check"></i>' : '<i class="fa fa-times-circle"></i>'; ?> </span></li>
    ...
    <section class="subscription-area" id="_subscription">
        ...
        <div class="container container-small">
            <div class="row">
                ...
                <div class="col-xl-6 col-12">
                    <div class="single-subscription">
                        <input name="phone" id="phone" type="number" minlength="6" maxlength="20" required="required" placeholder="<?php echo $this->lang->line('phone'); ?>*">
                    </div>
                </div>
                <div class="col-xl-6 col-12">
                    <div class="single-subscription">
            ...
            <div class="row" style="display: none;">
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="footer-widget">
                        ...
                        <ul>
                            <li><a href="#"><?php echo $this->lang->line('about_brand'); ?></a></li>
                            <li><a href="#"><?php echo $this->lang->line('demo_video'); ?></a></li>
                            <li><a href="#"><?php echo $this->lang->line('faq'); ?></a></li>
                            <li><a href="#"><?php echo $this->lang->line('pricing_plan'); ?></a></li>
