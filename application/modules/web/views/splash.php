...
<html lang="en">
    ...
    <body>
        ...
        <section class="video-area" id="_video">
            <div class="container container-big">
               ...
               <?php }else if($setting->demo_video == 'vimeo' && $setting->video_id != ''){ ?>
                    ...
                    <iframe src="https://player.vimeo.com/video/<?php echo $setting->video_id; ?>" style="width:100%; height:550px;" height="500" 
                            frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    <script src="https://player.vimeo.com/api/player.js"></script>
               <?php }else{ ?>                      
                    <iframe class="youtube-player" style="width:100%; height:550px;" height="550"
                            src="https://www.youtube.com/embed/fUUqVSEnpA4" frameborder="0">                               
                    </iframe>
               <?php } ?>     
            </div>
        </section>
        ...
        <style type="text/css">
            ...
            .stellarnav.mobile.light li a {padding: 15px 10px 22px !important;}
        </style>
